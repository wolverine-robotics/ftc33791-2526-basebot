...
@Autonomous()
public class FarBlueSideGP extends OpMode {
    // =====================================================================
    // INSTANCE VARIABLES
    // =====================================================================
    ...
    public static class FarBlueSideConfigurables {
        ...
        public static double shooterVelocityPreload = 1300;//1400
        public static double shooterVelocitySpikeMarks = 1430-35;
        public static double shooterVelocityLoadingZone = 1430-35;
