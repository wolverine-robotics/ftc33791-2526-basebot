...
@Autonomous()
public class FarRedSideGP extends OpMode {
    // =====================================================================
    // INSTANCE VARIABLES
    // =====================================================================
    ...
    public static class FarRedSideConfigurables {
        ...
        public static double shooterVelocityPreload = 1300-15-20;
        public static double shooterVelocitySpikeMarks = 1470-35;
        public static double shooterVelocityLoadingZone = 1470-35;
    ...
    public void buildPaths() {
        ...
        PrepIntakeLoadingZone = new Path(new BezierCurve(
                ...
                new Pose(100, 58.744),
                new Pose(126.000, 28.000)
        ));
        PrepIntakeLoadingZone.setLinearHeadingInterpolation(Math.toRadians(-90), Math.toRadians(-90));

        IntakeLoadingZone = new Path(new BezierLine(new Pose(130, 28.000), new Pose(130, 10.000)));
